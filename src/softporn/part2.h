...
{
	clearScreen();
	writeLongMessage(70, true);
	////writeLongMessage(71, true);
	////writeLongMessage(72, true);
	getKey();
	clearScreen();
	printf("\n\n\n\n");
}
...
void lookAtGraffiti()
{
	...
	////writeLongMessage(60, true);
	////writeLongMessage(61, true);
	////writeLongMessage(62, true);
	getKey();
	//clearScreen();
	//printf("\n\n\n\n");
}
...
{
watch:
	writeLongMessage(41 + state.TVChannel, true);
