...
const message messages[] = {
	...
	// Nostril". The pimp seems to like this one! He's engrossed in the action he sees! // LINE TOO LONG
    ...
    /* 1 */ { 25, 30 },
	// "Don't go there; do me first!"
    /* 2 */ { 55, 24 },
	// The door is locked shut.
    /* 3 */ { 79, 43 },
	// The pimp says I can't go until I get $2000.
    /* 4 */ { 122, 57 },
	// "Bruh, ain'tcha had enough for one night?" the pimp asks.
    /* 5 */ { 179, 43 },
	// The pimp takes $2000 and gives me the okay.
    /* 6 */ { 222, 20 },
	// Who are you kidding?
    /* 7 */ { 242, 22 },
    ...
    /* 14 */ { 377, 25 },
	// You're not a bird, silly.
    /* 15 */ { 402, 8 },
	// You hog.
    /* 16 */ { 410, 22 },
	// I'm carrying too much!
    /* 17 */ { 432, 48 },
	// The clerk shouts "Shoplifter!" and guns me down.
    /* 18 */ { 480, 6 },
	// Taken.
    /* 19 */ { 486, 22 },
	// I'm carrying too much!
	...
	// The clerk shouts "Shoplifter!" and guns me down.
    /* 21 */ { 556, 37 },
	// Get me a pitcher so I don't spill it.
    /* 22 */ { 593, 58 },
	// The hooker calls out to you, "Don't take it, do me first!"
    /* 23 */ { 651, 25 },
	// It's tied to the balcony.
    /* 24 */ { 676, 14 },
	// %s: Dropped.
    //
    /* 25 */ { 690, 26 },
    ...
    /* 28 */ { 793, 44 },
	// She blushes and puts it safely in her purse.
    /* 29 */ { 837, 43 },
	// She says, "Meet me at the marriage center!"
    /* 30 */ { 880, 61 },
	// "That stuff made me puke," the bum mutters. "Git outta here."
    /* 31 */ { 941, 37 },
	// The guy gives me a TV remote control.
    /* 32 */ { 978, 44 },
	// That's too much! One item at a time, please.
    /* 33 */ { 1022, 19 },
	// Its drawer is shut.
    /* 34 */ { 1041, 15 },
	// Dead roaches...
    /* 35 */ { 1056, 40 },
	// There's some pervert staring back at me.
    /* 36 */ { 1096, 46 },
	// Doesn't seem to be cleaned in ages. It stinks!
    /* 37 */ { 1142, 46 },
	// Looks like a whiskey-drinking kinda guy to me.
    /* 38 */ { 1188, 15 },
	// It says 'push'.
    /* 39 */ { 1203, 37 },
	// He's waiting for me to buy something.
    /* 40 */ { 1240, 67 },
	// He has a pin on his coat. "Support your local pimp -- gimme $2000".
    /* 41 */ { 1307, 37 },
	// I'd need the remote control for that.
    /* 42 */ { 1344, 31 },
	// The pimp says I can't watch TV.
    /* 43 */ { 1375, 34 },
	// Playing these might be more fun...
    /* 44 */ { 1409, 53 },
	// "Tell ya my story for a bottle o' wine," he grumbles.
    /* 45 */ { 1462, 66 },
	// All windows at the hotel across the road have their curtains shut.
    /* 46 */ { 1528, 17 },
	// The door is open.
    /* 47 */ { 1545, 26 },
	// The sign on the door says:
    /* 48 */ { 1571, 64 },
	// "Entry by showing passcard - club members and their guests only"
    /* 49 */ { 1635, 16 },
	// She ignores you.
    /* 50 */ { 1651, 33 },
	...
	// It's open.
    /* 52 */ { 1694, 42 },
	// Type "water on" or "water off" to operate.
    /* 53 */ { 1736, 21 },
	// Its doors are closed.
    /* 54 */ { 1757, 28 },
	// He's waiting for me to play.
    /* 55 */ { 1785, 10 },
	// It's open.
    /* 56 */ { 1795, 12 },
	// It's closed.
    /* 57 */ { 1807, 25 },
	// These bushes look lushes.
    /* 58 */ { 1832, 16 },
	// "Hail taxi here"
    /* 59 */ { 1848, 25 },
	// She slaps me for staring.
    /* 60 */ { 1873, 20 },
	// They look beautiful!
    /* 61 */ { 1893, 29 },
	// The label on the bottle says:
    /* 62 */ { 1922, 50 },
	// "Want to drive someone crazy with lust? Try this!"
    /* 63 */ { 1972, 43 },
	// Hello? There's a group of bushes behind it!
    /* 64 */ { 2015, 22 },
	// Maybe I should listen?
    /* 65 */ { 2037, 35 },
	// It's %s, %s-flavored, %s, and %s.
    //
    /* 66 */ { 2072, 20 },
	// It contains $%d00.
    //
	...
	// It's inflated.
    /* 69 */ { 2117, 36 },
	// It's all rolled up in a little ball.
    /* 70 */ { 2153, 19 },
	// It's full of water.
    /* 71 */ { 2172, 11 },
	// It's empty.
	...
	// It's already open.
    /* 77 */ { 2288, 53 },
	// A voice asks, "Passcard?". I search my pockets and...
    /* 78 */ { 2341, 26 },
	// I have it! The door opens.
    /* 79 */ { 2367, 16 },
	// I don't have it!
    /* 80 */ { 2383, 35 },
	// It seems to be remotely controlled.
    /* 81 */ { 2418, 43 },
	// Push the button to open the elevator doors.
    /* 82 */ { 2461, 17 },
	// I can't reach it.
    /* 83 */ { 2478, 30 },
	// It's already inflated, dimwit.
    /* 84 */ { 2508, 36 },
	// I can't if I'm not holding it close.
    /* 85 */ { 2544, 36 },
	// But the prime rate is already 257%%!
    /* 86 */ { 2580, 26 },
	// Okay, show me your slot...
    /* 87 */ { 2606, 24 },
	// Playful li'l bugger, eh?
    /* 88 */ { 2630, 59 },
	// A voice from behind the curtain says "What's the password?"
    /* 89 */ { 2689, 6 },
	// BELLYB
    /* 90 */ { 2695, 23 },
	...
	// KEN SE
    /* 93 */ { 2730, 35 },
	// "Cute, bruh. Real cute, but wrong."
    /* 94 */ { 2765, 14 },
	// "Wrong, bruh!"
    /* 95 */ { 2779, 43 },
	// The blonde calls out, "You can't go there!"
    /* 96 */ { 2822, 16 },
	// Pushy chump, eh?
    /* 97 */ { 2838, 18 },
	// The door's closed.
	...
	// Tastes awful.
    /* 102 */ { 2936, 57 },
	// This stuff's rot-gut! I'd rather give it to someone else.
    /* 103 */ { 2993, 31 },
	// Heheheheeey, this stuff's okay!
    /* 104 */ { 3024, 14 },
	// Sour grapes...
    /* 105 */ { 3038, 7 },
	// Thanks!
    /* 106 */ { 3045, 31 },
	// ...Huh? Get your head examined.
    /* 107 */ { 3076, 17 },
	// "Sorry, all out."
    /* 108 */ { 3093, 54 },
	...
	// "Sorry, all out."
    /* 110 */ { 3164, 56 },
	// The waitress takes $100 and says she'll be back shortly.
    /* 111 */ { 3220, 30 },
	// ...gee, that's taking a while.
    /* 112 */ { 3250, 47 },
	// The clerk takes $100 and gives me the magazine.
    /* 113 */ { 3297, 18 },
	// "Sorry, sold out."
    /* 114 */ { 3315, 34 },
	// I already paid the pimp, numbnuts.
    /* 115 */ { 3349, 24 },
	// After all that trickery?
    /* 116 */ { 3373, 27 },
	// Money can't buy everything.
    /* 117 */ { 3400, 27 },
	// It's not on the floor here.
    /* 118 */ { 3427, 26 },
	// Gotta find a working sink.
    /* 119 */ { 3453, 29 },
	// Water is running in the sink.
    /* 120 */ { 3482, 16 },
	// I have no water.
    /* 121 */ { 3498, 39 },
	// Somehow, a tree sprouts within seconds!
    /* 122 */ { 3537, 35 },
	// The seeds need better soil to grow.
    /* 123 */ { 3572, 25 },
    ...
    /* 127 */ { 3663, 28 },
	// The pitcher is already full.
    /* 128 */ { 3691, 31 },
	// I have nothing to pour it with.
    /* 129 */ { 3722, 21 },
	...
	// Eugh, punk rock.
    /* 133 */ { 3823, 64 },
	// An advertisement says "call 555-0987 for all your liquor needs!"
    /* 134 */ { 3887, 47 },
	// I should take it so I can hold it up to my ear.
    /* 135 */ { 3934, 25 },
	// Quiet as a mouse in heat.
    /* 136 */ { 3959, 17 },
	// I can't reach it.
    /* 137 */ { 3976, 15 },
	// No way, weirdo.
    ...
    /* 139 */ { 4012, 112 },
	// The girl says, "But you'll need $2000 for the honeymoon suite!"
    // The preacher chimes in, "I'll need $1000, too."
    /* 140 */ { 4124, 46 },
	// The preacher says, "I'll need $1000 for that."
    /* 141 */ { 4170, 44 },
	// She doesn't look like she can take any more.
    /* 142 */ { 4214, 43 },
	// Oh no! She gave me the dreaded Atomic Clap!
    /* 143 */ { 4257, 24 },
	// Inflate it first, dummy.
    /* 144 */ { 4281, 36 },
	// I can't unless I'm holding it close.
    /* 145 */ { 4317, 40 },
	// "I'm nervous. Don't you have some wine?"
    /* 146 */ { 4357, 42 },
	// He jumps over the bar and strikes me down!
    /* 147 */ { 4399, 48 },
	// (Now that's putting the 'ender' in 'bartender'!)
    /* 148 */ { 4447, 54 },
	// "Buddy, don't make me put the 'ender' in 'bartender'."
    /* 149 */ { 4501, 20 },
	// ... he got me there.
    /* 150 */ { 4521, 39 },
	// The whole point was to stop doing that!
    /* 151 */ { 4560, 36 },
	// She kicks me in the nads for trying.
    /* 152 */ { 4596, 19 },
	// "Wisen up, Buster!"
    /* 153 */ { 4615, 24 },
	// "Fuck off, I'm working!"
    /* 154 */ { 4639, 66 },
	// "Bruh, even if I'd let ya you couldn't afford me, foo'!" he mocks.
    /* 155 */ { 4705, 40 },
	// Let's not. I don't know where he's been!
    /* 156 */ { 4745, 24 },
	// "Don't make this weird."
    /* 157 */ { 4769, 40 },
	// Yeah? How 'bout *you* fuck off, asshole?
    /* 158 */ { 4809, 8 },
	// Pervert.
    /* 159 */ { 4817, 11 },
	// It tickles!
    /* 160 */ { 4828, 37 },
	// ~I got the constipation bluuueees...~
    /* 161 */ { 4865, 16 },
	// Ah, much better.
    /* 162 */ { 4881, 12 },
	// Ah, sleep...
    /* 163 */ { 4893, 51 },
	// No wait! I can't sleep yet, I gotta find me a girl!
    /* 164 */ { 4944, 45 },
	// Okay, the safety rope is tied to the balcony.
    /* 165 */ { 4989, 39 },
	// I flash my passcard and the door opens.
    /* 166 */ { 5028, 32 },
	// Let me see if I still have it...
    /* 167 */ { 5060, 33 },
	// Yeah, I do. And it works! Thanks!
    /* 168 */ { 5093, 28 },
	// Samurai sex fiend, YEEEAAAH!
    /* 169 */ { 5121, 33 },
	// ...I accidentally stabbed myself.
    /* 170 */ { 5154, 47 },
	// A girl says, "Hi honey! This is %s. Dear, why
    //
    /* 171 */ { 5201, 44 },
    ...
    /* 176 */ { 5369, 31 },
	// This only takes incoming calls.
    /* 177 */ { 5400, 34 },
	// I mean, I could talk to my hand...
    /* 178 */ { 5434, 85 },
	// A voice on the line says "Hello. Please answer the questions with
    // one-word answers."
    /* 179 */ { 5519, 37 },
	...
	// Nobody answers.
    /* 186 */ { 5731, 47 },
	// Using the hammer, I smash the window to pieces.
    /* 187 */ { 5778, 42 },
	// If I had something to break it with, sure!
    /* 188 */ { 5820, 40 },
	// Let me see if I still have that knife...
    /* 189 */ { 5860, 33 },
	// Yeah, I do. And it works! Thanks!
    /* 190 */ { 5893, 28 },
	// Samurai sex fiend, YEEEAAAH!
    ...
    /* 197 */ { 6051, 30 },
	// "I don't need yo money, bruh."
    /* 198 */ { 6081, 36 },
	// He'll take the money when you go up.
    /* 199 */ { 6117, 35 },
	// You already paid the pimp, dum-dum.
    /* 200 */ { 6152, 24 },
	// After all that trickery?
    /* 201 */ { 6176, 46 },
	// "What do you take me for, some common skank!?"
    /* 202 */ { 6222, 42 },
	// She punches me right in the vulnerables...
    /* 203 */ { 6264, 54 },
	// Bring a girl here to marry, he'll take the money then.
    /* 204 */ { 6318, 40 },
	// He's too drunk to do business right now.
    /* 205 */ { 6358, 41 },
	// Buy something, he'll take the money then.
    /* 206 */ { 6399, 44 },
	// Why not play 21 instead? You'll lose anyway!
    /* 207 */ { 6443, 37 },
	// A cop comes running and guns me down!
    /* 208 */ { 6480, 39 },
	// I flash my passcard and the door opens.
    /* 209 */ { 6519, 10 },
	// Hmm. Nice!
    /* 210 */ { 6529, 29 },
	// Okay, who's eating tuna fish?
    /* 211 */ { 6558, 21 },
	// Augh, I'm gonna puke!
    /* 212 */ { 6579, 34 },
	// ...Achoo! Hmm. Guess I'm allergic?
    /* 213 */ { 6613, 9 },
	// Yeeeccch!
    /* 214 */ { 6622, 20 },
	// Smells like perfume.
    ...
    /* 217 */ { 6688, 43 },
	// Can't you see the bar on top of the screen?
    /* 218 */ { 6731, 25 },
	// Save to which slot? (0-9)
    /* 219 */ { 6756, 11 },
	// SOFTP-#.SAV
    /* 220 */ { 6767, 19 },
	// Couldn't open %s.
